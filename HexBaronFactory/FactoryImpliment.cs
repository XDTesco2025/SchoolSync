...
namespace HexBaronCS
{
    class Program
    {
        ...
        public static bool CheckUpgradeCommandFormat(List<string> items)
        {
            ...
            if (items.Count == 3)
            {
                if (items[1].ToUpper() != "LESS" && items[1].ToUpper() != "PBDS" && items[1].ToUpper() != "SCFW")
                    return false;
                try
                {
    ...
    class SCFWPiece : Piece
    {
       public SCFWPiece(bool player1)
        ...
        public void supply()
        {
            //This piece dies and Factory is born
            DestroyPiece()
        }
    ...
    class Factory : Piece
    {
        public FactoryPiece(bool player1)
        : base(player1)
        {
            pieceType = "F";
            VPValue = 2;
